    ...
    <>
      ...
      <main style={{
        ...
        <div style={{ maxWidth: 480, margin: '0 auto', padding: '80px 24px', textAlign: 'center' }}>
          <div style={{ width: 80, height: 80, background: 'rgba(245,158,11,0.1)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 24px', border: '1px solid rgba(245,158,11,0.2)' }}>
            <AlertTriangle size={40} color="#f59e0b" />
          </div>
          <h1 style={{ fontSize: 28, fontWeight: 400, marginBottom: 12 }}>Hubo un problema con el pago</h1>
          <p style={{ color: '#888', fontSize: 15, lineHeight: 1.6, marginBottom: 8 }}>
            El pago no pudo procesarse. Tu pedido está guardado — podés intentarlo de nuevo cuando quieras.
          </p>
          {orderId && (
